        ...
        <>
            ...
            <div id="home" className="hero-text-column">
                ...
                <motion.h1
                    ...
                    animate="visible"
                >
                    <motion.span vairiants={wordVariant} style={ { display:
                        "inline-block" } }>
                            YOUR PLACE
                    </motion.span>
                    <br />
                    <motion.span
                        vairiants={wordVariant}
                        className="muted"
                    ...
                    <motion.span variants={wordVariant} style={ { display:
                        "inline-block"} } >
                            BREWING
                        </motion.span>
                </motion.h1>
                ...
                >
                    Farm-to-cup single-origin beans from Ethiopoa, Colombia $ beyond.
                    Freashly roaster in small batches and shipped to your door within 48 
                    hours.
                </motion.p>
                ...
                <span className="hero-trust-divide">|</span>
            ...
            <div className="hero-art-container">
                ...
                >
                    ...
                    <span className="hero-floating-badge-label">per bg</span>
                </motion.div>
