...
const values = [
    {
    ...
    },
     {
        ...
        title:"Small-Batch Roasting",
        description:
            "Our masyer roaster profiles every bean to unlock its peak flavor. We roast in 25lb batches for consistency and freshness you can taste"
...
export default function AboutSection() {
    return(
        <div className="about-content">
            ...
            {/* Two-Colum story with image */}
            <div className="about-story-grid">
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    <p className="about-body lead--light">
                        The Beans Place started in 2012 with one simple belief; 
                        great coffee should be accessible to everyone- not just aficionados. 
                        We work directly with farming cooperative across four continents, 
                        paying aboue fair-trade prices to ensurequality from soil to sip.
                    </p>

                    <p className="about-body lead--light">
                        Every week, our roastmaster cups dozens of samples to select only
                        the lots that meet our standard. Whether you prefer a bright,
                        fruity Ethiopian Yirgacheffe or a deep, shocolately Colombian
                        Supremo, we roast each batch to order so it arrives at peak freshness.
                    </p>
                    ...
                    <StaggerItem key={v.title} animation="fadeUp">
                        <Card glass className="about-value-card">
                            <CardHeader>
                                ...
                                <h3 className="text-lg font-bold text-(--cream)">{v.title}
                                </h3>
                            </CardHeader>
