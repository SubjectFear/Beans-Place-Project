...
export default function ProductShowcase({ products = [], addToCart }) {
  return (
    <div className="product-showcase">
      ...
      <ScrollReveal animation="fadeUp" delay={0.15}>
        <p className="product-showcase-subtitle">
          Hand-selected single-origin coffees, reoaster to order. Each bag ships
          within 48 hours of riasting for maximum freshness.
        </p>
      </ScrollReveal>
